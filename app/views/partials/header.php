    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active" href="/tienda-solar/index.php">Inicio</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/tienda-solar/index.php#servicios">Servicios</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/tienda-solar/index.php#nosotros">Nosotros</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/tienda-solar/index.php#contacto">Contacto</a>
